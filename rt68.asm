...
;* Initialize the User vector
        ldx     #SBRET          ;* It's a RTS @SBRET
        stx     USRDEF          ;* Default for User command
;*
	LDX  #ACIACS    ;* #$8000
...
;*
CMDTBL	EQU  *  	;* 
	FCB  'B' 	;* BREAKPOINT COMMAND ROUTINE B,201B
	FDB  BKPCOM	;* 
	FCB  'D' 	;* Hex dump D,0000,000F
	FDB  DMPCOM	;* 
	FCB  'E' 	;* EXECUTE SINGLE TASK COMMAND
	FDB  EXCOM	;* 
	FCB  'G' 	;* GO TO USER PGM OR RETURN FROM BREAKPOINT COMMAND ROUTINE
	FDB  GOCOM	;* 
	FCB  'L' 	;* Load S19 file
	FDB  LOAD	;* 
	FCB  'M' 	;* WRITE TAPE COMMAND
	FDB  MEMCOM	;* 
	FCB  'P' 	;* Punch S19 P,2000,2037
	FDB  PUNCOM	;* 
	FCB  'R' 	;* Print Registers
	FDB  PRSTAK	;* 
	FCB  'S' 	;* ACTIVATES AND INITIALIZES RT/68 EXECUTIVE
	FDB  SYSCOM	;* 
